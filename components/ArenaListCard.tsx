...
const ArenaListCard: React.FC<Props> = ({
  ...
  return (
    <motion.button
      ...
      className="group relative flex flex-col text-left w-full min-w-0 rounded-2xl border border-white/[0.07] bg-gradient-to-b from-white/[0.04] to-[#040810]/90 backdrop-blur-md p-4 sm:p-4 shadow-[0_8px_32px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.05)] overflow-hidden
        hover:border-[#00f3ff]/35 hover:shadow-[0_12px_40px_rgba(0,243,255,0.1)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#00f3ff]/50"
    >
      <div
      ...
      <div className="flex items-start gap-3 relative z-10">
        ...
        <div className="shrink-0 self-center opacity-40 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all duration-300">
