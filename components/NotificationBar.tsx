...
import { Bell, TrendingDown, TrendingUp, ExternalLink, Loader2, Mail } from 'lucide-react';
import { Link } from 'react-router-dom';
import { formatEther } from 'viem';
import { getActivityOnMyMarkets, getUserPositions, getCurveLabel, type PositionActivityNotification } from '../services/graphql';
import { formatMarketValue, formatDisplayedShares } from '../services/analytics';
import { requestEmailNotification } from '../services/emailNotifications';
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        aria-label="Activity on your markets"
      >
        <Bell size={18} />
        {items.length > 0 && (
          ...
          <div className="overflow-y-auto max-h-[calc(75vh-140px)] p-1 scroll-smooth" style={{ scrollBehavior: 'smooth' }}>
            {loading && items.length === 0 ? (
              ...
              <div className="py-10 px-4 text-center text-[11px] font-bold font-mono text-slate-400 uppercase tracking-widest">
                {items.length === 0
                  ? 'No recent activity in your holdings. When others buy or sell in a claim you hold, it will appear here.'
