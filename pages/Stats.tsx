...
import { Trophy, Medal, Award, Zap, TrendingUp, Crown, Crosshair } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        {loading ? (
           <div className="flex flex-col items-center justify-center h-64 gap-4">
              ...
              <div className="text-yellow-400 font-bold text-xl animate-bounce">INSERT COIN...</div>
           </div>
        ) : (
          <>
            {/* Top 3 Podium */}
